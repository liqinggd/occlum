...
static int __test_truncate_read(const char *file_path) {
    size_t file_len = 32;
    off_t small_len = 16;
    off_t big_len = 48;
    char read_buf[128] = { 0 };
...
static int test_truncate_read() {
    return test_file_framework(__test_truncate_read);
}

/*static int test_truncate_write() {
    return test_file_framework(__test_truncate_write);
}*/
...
static test_case_t test_cases[] = {
    ...
    TEST_CASE(test_truncate_read),
//    TEST_CASE(test_truncate_write),
};
